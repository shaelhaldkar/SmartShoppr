...
public class ShowBookMarkAdapter  extends RecyclerView.Adapter<SeeAllItemViewHolder> {
    ...
    private ImageLoadingListener animateFirstListener = new ShowBookMarkAdapter.AnimateFirstDisplayListener();
    private Context context;

    public ShowBookMarkAdapter(Context context, ArrayList<ResponseModel> dataList ) {
