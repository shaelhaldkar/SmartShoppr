...
import com.sukritapp.smartshoppr.model.ItemData;
 ...
 */
public class SeeAllItemViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public SeeAllItemViewHolder(View itemView, ArrayList<ResponseModel> dataList) {
        super(itemView);
