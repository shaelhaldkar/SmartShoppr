...
public class TermsAndConditionFragment extends Fragment implements OnSukritResponseListner {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        new WebRetriveDataTask().retriveData(getActivity(), this, Constant.listtype.ABOUTUS, null, "http://www.mgsmapi.semseosmo.com/about/aboutList");
    ...
    public void onResponseReceived(String error,Constant.listtype tag, String response) {
        ...
        if(error ==null) {
            ...
            try {
                ...
                JSONArray jsonArray = jObject.getJSONArray("faq_list");
