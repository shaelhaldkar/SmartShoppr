...
public class FAQFragment extends Fragment implements OnSukritResponseListner {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        new WebRetriveDataTask().retriveData(getActivity(), this, Constant.listtype.FAQ, null, "http://www.mgsmapi.semseosmo.com/faq/faqList");
